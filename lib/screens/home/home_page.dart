...
import 'package:online_notes_app/screens/home/add_notes_page.dart';
import 'package:online_notes_app/screens/home/edit_note_page.dart';
                  ...
                  trailing: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => Edit_Note_Page(),
                                  ));
                            },
                        ...
                        InkWell(
                            onTap: () {
                              Notes.doc(snapshot.data!.docs[index].id)
                                  .delete()
                                  .then((value) {
                                print("Note deleted");
                              });
